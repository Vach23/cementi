    ...
    <nav class="main-nav" id="main-nav">
        <div class="nav-inner">
            ...
            <div class="nav-auth" id="nav-auth">
                ${user
                    ? '<span class="nav-user">' + esc(user.display_name) + '</span><button type="button" class="nav-link-btn" data-logout>Odhlásit</button>'
                    : '<button type="button" class="nav-link-btn" data-open-modal="login-modal">Přihlásit se</button>'
                }
            </div>
            <button type="button" class="nav-hamburger" data-nav-toggle aria-label="Otevřít menu" aria-controls="nav-links nav-auth" aria-expanded="false">
