...
var esc = helpers.esc;
var stylePath = path.join(__dirname, '..', 'public', 'css', 'style.css');
var styleVersion = '';
try {
    styleVersion = '?v=' + Math.floor(fs.statSync(stylePath).mtimeMs);
} catch (e) { }
...
<head>
    ...
    <link rel="preload" href="/css/style.css${styleVersion}" as="style" />
